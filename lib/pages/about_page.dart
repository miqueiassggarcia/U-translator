  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: SizedBox(
          ...
          child: ListView(
            ...
            children: [
              SizedBox(height: 50,),
              Text("Sobre o Aplicativo de Leitura e Tradução de PDF", 
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18), 
                  textAlign: TextAlign.center,
              ),
              SizedBox(height: 20,),
              Text("Bem-vindo ao nosso aplicativo de Leitura e Tradução de PDF! " +
              ...
              Text("Nossa Missão",
                ...
                textAlign: TextAlign.center),
              SizedBox(height: 20,),
              Text("Nosso objetivo é proporcionar uma maneira eficaz e envolvente de estudar " +
              ...
              Text("Nossa Equipe",
                ...
                textAlign: TextAlign.center),
              SizedBox(height: 20,),
              Text("Somos uma equipe apaixonada por idiomas e educação. "+
                "Estamos comprometidos em fornecer a você as ferramentas de " +
                "que você precisa para se tornar fluente em um novo idioma.",
                textAlign: TextAlign.center,),
              Text("Obrigado por escolher nosso aplicativo. Esperamos que ele seja " +
